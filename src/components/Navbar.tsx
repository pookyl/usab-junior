...
import { Trophy, Home, Swords, Users, Moon, Sun, Monitor, Calendar, RefreshCw, CalendarDays } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/tournaments', label: 'Tournaments', shortLabel: 'Events', icon: CalendarDays },
